#FamousSyncBug
> An example of how the sync does not set the options correctly.

[![Build Status](https://travis-ci.org/drclick/famoussyncbug.svg?branch=master)](https://travis-ci.org/drclick/famoussyncbug) [![Dependency Status](https://david-dm.org/drclick/famoussyncbug.svg)](https://david-dm.org/drclick/famoussyncbug) [![devDependency Status](https://david-dm.org/drclick/famoussyncbug/dev-status.svg)](https://david-dm.org/drclick/famoussyncbug#info=devDependencies)
